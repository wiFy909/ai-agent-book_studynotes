...
Run 3-1/3-2 first because 3-10 and 3-12 consume the same three-layer suite and
judge contract. Run 3-4 before 3-6/3-11 so the local dense encoder is warm. The
data-independent experiments (3-3/3-5) can run at any point. Experiment 3-13
