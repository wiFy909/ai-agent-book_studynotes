...
- Better parallelization and significantly less training time than existing models

---

## Background: Limitations of Current Models
- **RNN/LSTM**: Inherently sequential, poor parallelization
- **Convolutional models**: Limited long-range dependencies (ConvS2S: linear growth; ByteNet: logarithmic)
...
- Stack of 6 identical layers, each with two sub-layers:
...
- More efficient than additive attention while performing similarly for small dk
...
## Positional Encoding
- Inject sequence order information since model has no recurrence/convolution
