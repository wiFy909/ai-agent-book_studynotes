...
Why can code generation carry this weight? Because it is not just one tool in the toolbox, but a **meta-capability** — the ability to create new tools and capabilities dynamically at runtime. The latter half of this chapter develops this concept in full, along with the six directions in which it applies.
...
Following this thread—from the inside out and ultimately back to the Agent itself—makes the unified value of code as a meta-capability easier to see. Building on this foundation, Chapter 9 examines what operational evidence should trigger self-modification and how candidate modifications enter a new version through testing, release, and rollback.
