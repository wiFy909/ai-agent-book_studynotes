...
> 📥 **[Download PDF / EPUB](#-e-book)** (recommended) — the PDF / EPUB editions offer the best reading experience; you can also [read online](https://bojieli.github.io/ai-agent-book/) (Chinese/English edition selector, collapsible chapter tree, full-text search, auto-rebuilt on every push to main).
...
| 📚 **10 chapters** of text, from basics to production | 📂 **93** companion projects (70+ standalone) | 🈶 Chinese / English |
| :---: | :---: | :---: |
...
>
> 🌐 You can also [read online](https://bojieli.github.io/ai-agent-book/) — Chinese/English edition selector, collapsible chapter tree, full-text search, and direct links to companion experiments. Auto-rebuilt on every push to main.

Chinese text source is in [`book/`](../../book/); the English edition is a community contribution (and may lag behind the Chinese original), located in [`book-en/`](../../book-en/).

The shared builder produces EPUB 3 editions for Simplified Chinese and English. See the [EPUB build instructions](../../EPUB.md).
